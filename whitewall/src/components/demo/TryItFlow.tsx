...
import { identityRegistryAbi, worldIdValidatorAbi } from "../../lib/whitewall-os/abis";
import { addresses } from "../../lib/whitewall-os/addresses";
...
export function TryItFlow({ dispatch, wallet, agent }: {
  ...
  const connectWallet = useCallback(async () => {
    ...
    try {
      ...
      const { humanVerifiedPolicyAbi } = await import("../../lib/whitewall-os/abis");
